...
for occ in ten_occ:
    vocab_set.add(occ[0]) #on ajoute le mot au set de vocabulaire
...
oov_rate = (n_unk/len(all_tokens))*100 #formule du OOV_Rate
print("%.3f" %oov_rate) #https://www.askpython.com/python/string/print-format-3f
